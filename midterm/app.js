...
// MONGO SETUP
var uri = 'mongodb://wangq277:3506@ds049476.mlab.com:49476/qihui';
MongoClient.connect(uri, function(err, database){
	...
	app.post('/delete',function(req,res){
		var deleteWordObject = (JSON.stringify(req.body));
			console.log(deleteWordObject);
			var deleteWord = deleteWordObject.replace('{"','').replace('":""}','');

       console.log('delete this word:' + deleteWord);
    
    words.remove({"word": deleteWord});
